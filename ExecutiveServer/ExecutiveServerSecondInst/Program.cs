using ExecutiveServerSecondInst.EF;
...
namespace ExecutiveServerSecondInst
{
    class Program
    {
        private static string serverHostName = "http://localhost:8888";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Service with the following host address http://localhost:8888 has started");
            Console.WriteLine("//////");
